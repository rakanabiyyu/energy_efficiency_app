...
if btn_hitung:
    ...
    with res_col2:
        ...
        href = f'<a href="data:application/octet-stream;base64,{b64}" download="Report_Energy_Efficiency.pdf"><button style="width:100%; height:50px; background-color:#FF4B4B; color:white; border:none; border-radius:5px; cursor:pointer; font-weight:bold;">📥 Download PDF Report</button></a>'
